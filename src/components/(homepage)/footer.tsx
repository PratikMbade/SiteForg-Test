...
const Footer1 = () => {
  return (
    <>
      <footer className="relative z-10 bg-neutral-300 border-t  w-full dark:bg-black    flex flex-col items-center justify-center mt-10 ">
            ...
            <div className="mb-10 w-full">
              <Link href="/" className="mb-6 flex  max-w-[160px] ">
                <div className="flex items-center justify-center">
                  <p className="text-2xl font-extrabold">Site Forg</p>
                </div>
              </Link>
              <p className="mb-7 text-base text-body-color dark:text-dark-6">
                104 Business bay , dubai
              </p>
