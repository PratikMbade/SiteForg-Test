...
const HeroProduct = ({
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2  place-items-center py-10 mx-48">
      ...
      <div className="flex flex-col items-center justify-center  order-2 lg:order-1 my-4">
       ...
       <AnimatedGradientTextDemo/>
        ...
        <div className="mx-5  flex items-center justify-center flex-col max-w-2xl">
          <p className="text-3xl sm:text-7xl font-extrabold relative z-10 bg-clip-text  dark:text-transparent dark:bg-gradient-to-b dark:from-neutral-200 dark:to-neutral-500 pt-4 max-w-4xl text-center drop-shadow-xl">
